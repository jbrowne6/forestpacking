...
void naive::makePredictionsMultiObs(const inferenceSamples& observations, int numCores){
...
void naive::makePredictionsMultiTree(const inferenceSamples& observations, int numCores){
