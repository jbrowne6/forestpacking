...
void improv4::makePredictions(const inferenceSamples& observations){
...
void improv4::makePredictionsMultiObs(const inferenceSamples& observations, int numCores){
...
void improv4::makePredictionsMultiTree(const inferenceSamples& observations, int numCores){
