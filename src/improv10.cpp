...
improv10::improv10(const std::string& forestCSVFileName, int source, const inferenceSamples& observations, int numberBins, int depthIntertwined){
    if(source == 1){
...
void improv10::makePredictions(const inferenceSamples& observations){
