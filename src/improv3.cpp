...
improv3::improv3(const std::string& forestCSVFileName, int source, const inferenceSamples& observations){
    if(source == 1){
...
void improv3::makePredictions(const inferenceSamples& observations){
